...
# Import Crime Data
crime17 = pd.read_csv(r"https://data.cityofchicago.org/api/views/d62x-nvdr/rows.csv?accessType=DOWNLOAD")
crime18 = pd.read_csv(r"https://data.cityofchicago.org/api/views/3i3m-jwuy/rows.csv?accessType=DOWNLOAD")
...
crime17_cleaned.to_csv("..\crime17_cleaned.csv")
crime18_cleaned = clean_dataset(crime18)
crime18_cleaned.to_csv("..\crime18_cleaned.csv")
